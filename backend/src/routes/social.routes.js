...
const { toggleLike, addComment, deleteComment, toggleFavourite, getMyFavourites, tagUser, shareMedia, deleteTag } = require('../controllers/social.controller');
...
router.delete('/tag/:id', authenticate, deleteTag);
